...
RUN apt-get update && apt-get -y install xserver-xorg-video-dummy x11vnc xdotool wget tar supervisor net-tools fluxbox gnupg2 python python-numpy x11-xserver-utils
